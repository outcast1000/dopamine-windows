    ...
    public partial class App : PrismApplication
    {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            void RegisterRepositories()
            {
                ...
                //containerRegistry.RegisterSingleton<IPlaylistTrackVRepository, SQLitePlaylistTrackVRepository>();
                ...
                containerRegistry.RegisterSingleton<IInfoRepository, SQLiteInfoRepository>();
            ...
            void RegisterViews()
            {
                ...
                containerRegistry.Register<object, CollectionHistory>(typeof(CollectionHistory).FullName);
                containerRegistry.Register<object, CollectionHistoryLog>(typeof(CollectionHistoryLog).FullName);
